...
public class Chatbot {
    ...
    // 多线程重置对话
    public void resetChat(String qq) {
        Client.threadMap.remove(qq);
    }
    ...
    //多线程请求
    public Map<String, Object> getChatResponseByThread(String prompt, String conversationId, String parentId, String output) {
        Map<String, Object> data = new HashMap<>();
        data.put("action", "next");
        data.put("conversation_id", conversationId);
        data.put("parent_message_id", parentId);
        data.put("model", "text-davinci-002-render");
        ...
        this.conversationIdPrev = conversationId;
        this.parentIdPrev = parentId;
